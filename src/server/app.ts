 ...
 */
export function classifyAiError(msg: string): 'quota' | 'overloaded' | 'missing-model' | 'truncated-stream' | null {
  if (/Incomplete JSON segment|Unexpected end of JSON|Response body is empty/i.test(msg)) return 'truncated-stream';
